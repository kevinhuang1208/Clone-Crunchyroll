...
function Footer() {
    ...
    return (
        <div className="allFooterContainer">
            <div className='footerTechContainer'>
                <div className='footer-column-name'>
                    <h2>Technologies Used:</h2>

                </div>
                <div className='tech-column-container'>
            ...
            <div className='footerContributorContainer'>
                <div>
                    <h2 className='footer-column-name'>Contributors:</h2>
                </div>
            ...
            <div>
                <img className = "footer-image" src="https://media.discordapp.net/attachments/1113213089702228038/1115712691407949916/image-removebg-preview.png?width=236&height=232"/>
            </div>
        </div>
    )
}
